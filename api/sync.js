...
export default async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      if (data === undefined) {
        return res.status(400).json({ error: 'No data', bodyType: typeof req.body, bodyKeys: req.body ? Object.keys(req.body) : [] });
      }
